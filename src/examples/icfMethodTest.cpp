...
int main(int argc, char** argv)
{
  ...
  std::string finallFilename=argv[3];
  ...
  pcl::io::savePCDFile(finallFilename,*finalCloud);
  std::cout<<">>> Write pcd to file "<<finallFilename<<std::endl;
  
  /*pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> color_h1(cloud,150,150,150);//gray
  pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> color_h2(finalCloud,150,10,10);//red
  pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> color_h3(modelCloudData,10,150,10);//green
